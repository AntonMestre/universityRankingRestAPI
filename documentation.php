		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col" style="margin-left:25px;margin-top:20px;">
					...
					<h3>What is UniversityRankingRestAPI ?</h3>
					...
					<h3>What information do you have access to?</h3>
					...
					{ </br>
						...
						"inhabitantsByUniversities":"83667.919354839",</br>
						"RankInhabitantsByUniversities":"4",</br>
